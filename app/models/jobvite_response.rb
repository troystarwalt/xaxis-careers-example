class JobviteResponse < ActiveRecord::Base
  ...
  def self.force_update_warning
    ...
    output_string = "Are you sure? The last update was at #{JobviteResponse.last.get_updated_at}, only #{minutes_since_update} minutes ago. Forcing updates too often my result in rate-limiting from Jobvite."
  end
